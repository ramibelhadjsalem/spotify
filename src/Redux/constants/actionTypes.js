...
export const SETPLAYLISTS ="SET_PLAY_LISTS"
export const SETRECENTLYPLAYED ="SET_RECENTLY_PLAYED"
export const SetRandPlayList ="SET_RAND_PLAYLIST"
export const LOGOUT = 'LOGOUT';
export const LOGIN = 'LOGIN';

export const SETCATEGORIES="SET_CATEGORIES"
export const getPlayListById = "GET_PLAYLIST_BY_ID"